...
def _download_and_preprocess_data(data_dir):
    ...
    print("Downloading French Voxforge data set into {} if not already present...".format(archive_dir))
    ...
    print("Extracting French Voxforge data set into {} if not already present...".format(data_dir))
    ...
    # Generate data set
    print("Generating French Voxforge data set into {}".format(data_dir))
